            ...
            <div className="p-5" >
                <div className="row d-flex justify-content-center align-items-center">
                    <div className="col-md-2 p-5">
                        <img src={profileImage}  alt="profile"  className="rounded img-fluid"/>
                    </div>
                    <div className="col-md-10 lh-lg p-5">
                        I'm Alkida Vaci, an electronic engineering graduate from Albania currently living in New York City. I'm passionate about coding and I'm currently enrolled in a coding bootcamp to expand my knowledge and experience in the field.
